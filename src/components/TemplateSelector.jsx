        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {savedRoutines.map((routine) => (
              <div
                key={routine.id}
                className="relative cute-button flex flex-col items-center justify-center p-5 md:p-6 rounded-3xl min-h-[160px] transition-all duration-200 touch-manipulation border-3 bg-pink-100 border-transparent hover:bg-pink-200 hover:shadow-md cursor-pointer"
